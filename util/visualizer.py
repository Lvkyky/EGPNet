...
#可视化特征图函数
def visulize(features,wordir,case,numcount,name,mode):
    imgdir = wordir+'/'+'visual'+str(case)+'/'+str(numcount)
    if not os.path.exists(imgdir):
        os.mkdir(imgdir)
    image_name = wordir+'/'+'visual'+str(case) + '/' +str(numcount)+'/'+name+'.jpg'
    numpy_name = wordir+'/'+'visual'+str(case) + '/' +str(numcount)+'/'+name+'.npy'
